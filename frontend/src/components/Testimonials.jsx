          ...
          <div className='grid grid-cols-1 lg:grid-cols-[2fr_5fr] gap-20 mb-16 rounded-2xl'>
            ...
            <div className='flex items-start justify-between flex-col gap-10'>
              ...
              <div className='flex flex-col gap-1 bg-white p-2 rounded'>
                ...
                <div className='medium-14'>Showing 1-2 out of <b>2k reviews</b></div>
              </div>
            </div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-7'>
              {/* Review Card */}
              <div className='glex flex-col gap-1 rounded-lg p-4 bg-white ring-1 ring-slate-900/5'>
                ...
                <div className='flex gap-x-1 mt-5'>
                  <img src={property1} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={property2} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
              <div className='glex flex-col gap-1 rounded-lg p-4 bg-white ring-1 ring-slate-900/5'>
                <div className='flexBetween'>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi odit dolorem neque et vero iusto velit veritatis consequatur est. Mollitia totam ex quas veritatis fuga excepturi corrupti placeat cum, quia nostrum?</p>
                <div className='flex gap-x-1 mt-5'>
                  <img src={property3} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={property4} alt="prdctImg" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
